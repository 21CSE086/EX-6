public class ThrowUsedCarExceptions {
    public static void main(String[] args) {
        UsedCar[] usedCars = new UsedCar[7];
                try {
                        usedCars[0] = new Usedcar("3400","audi",1983,5000,22220);
                }
                catch(UsedCarException e) {
                        System.out.println(e.getMessage());
                }
                try {
                        usedCars[1] = new Usedcar("5000","bmw",2003,60000,20000);
                ...
                try {
                        usedCars[2] = new Usedcar("2251","honda",1999,5320,120000);
                }
                catch(UsedCarException e) {
                        System.out.println(e.getMessage());
                }
                try {
                        usedCars[3] = new Usedcar("5123","ford",2021,5320,40000);
                }
                catch(UsedCarException e) {
                        System.out.println(e.getMessage());
                }
...
class Usedcar {
        ...
        public UsedCar(String vin,String process,int year,int mileage,int amount) throws UsedCarException {
                ...
                if(!(process.equals("audi")||process.equals("bmw")||process.equals("honda")||process.equals("ford")||process.equals("other"))
                        throw new UsedCarException(vin);
                }
